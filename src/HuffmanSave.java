...
/**
 * Simple container class that stores a bit sequence representing a Huffman encoded file along with
 * frequency information that may be used to reconstruct the Huffman tree used for the encoding. The
 * frequency HashMap maps from bytes to the number of occurrences of those bytes in the source
 * document.
 *
